        ...
        var tools = {
            ...
            getMaxDate: function (element) {
                ...
                switch (settings.scale) {
                    ...
                    default:
                        maxDate.setHours(0);
                        maxDate.setDate(maxDate.getDate() + 7); /*日期往后延伸天数*/
                        break;
                }
                return maxDate;
            },
            getMinDate: function (element) {
                ...
                switch (settings.scale) {
                    ...
                    case "weeks":
                        ...
                        var bd = new Date(bd.setDate(bd.getDate() - 3 * 7));
                        var md = Math.floor(bd.getDate() / 7) * 7;
                        minDate = new Date(bd.getFullYear(), bd.getMonth(), md === 0 ? 4 : md - 4);
                        break;
                    case "months":
                    ...
                    default:
                        minDate.setHours(0);
                        minDate.setDate(minDate.getDate() - 7);/*日期往前延伸天数*/
                        break;
                }
                return minDate;
            },
